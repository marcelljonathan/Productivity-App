...
export default function FuturesDailyCalendar({ yearMonth, trades, onDayClick }: Props) {
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap gap-x-3 gap-y-1 text-xs text-muted-foreground">
        ...
        <span className="flex items-center gap-1"><span className="inline-block w-3 h-3 rounded bg-blue-200 dark:bg-blue-800/60" /> Traded</span>
      </div>
